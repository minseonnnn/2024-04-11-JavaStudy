 ...
 *                 => 업로드 / 다운로드 
 *                 => 추천 => 카페 / 블로그 => 읽은 데이터를 파일에 저장후에 분석 => 분석된 데이터는 오라클로 전송 
 *                    => 임시 저장
 *     2. 파일 정보 => 376page => 파일 입출력
 *       --------   --------
 *                  | 377page에 나오는 메소드
