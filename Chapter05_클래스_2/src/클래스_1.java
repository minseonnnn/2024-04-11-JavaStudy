...
class Card
{
	 ...
	 *      ---------------------------------------------------------------------------------
	 *       지역변수       메소드 호출          메소드가 종료       Stack    메소드안에서만 사용 가능
	 *                   =>메모리에 저장       return의 해제
	 *      ---------------------------------------------------------------------------------
	 ...
	 *              
	 *              ------
	 *            --------- => a.aa (.은 메모리 주소 접근 연산자) => a주소 안에 저장되어 있는 aa라는 변수에 접근                                                
	 *      ---------------------------------------------------------------------------------
...
public class 클래스_1 {
	...
	public static void main(String[] args) {
		 ...
		 *                                        -----------  
		 */
		// static 변수 변경 => 같은 메모리 공간을 제어 => 모두 변경
		card1.width=300;
		card1.height=500;
