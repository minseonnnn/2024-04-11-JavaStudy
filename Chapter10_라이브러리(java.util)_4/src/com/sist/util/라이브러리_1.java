 ...
 *           |            -----------      -------------    
 *           |            |         |      |           | 
 *        구현 클래스   **HashSet   TreeSet  **HashMap  Hashtable     
 *       ------------------
 *       |        |       |
 ...
 *           5. ArrayList/Vector/LinkenList는 List라는 인터페이스를 구현
 *              => 메소드가 동일 (표준화)
 *              => 주요기능
 *                 ***= add() : 추가
 *                 = remove() : 삭제
...
public class 라이브러리_1 {
	...
	public static void main(String[] args) {
        ...
        Set s=map.keySet(); // key만 저장 => 중복을 허용하면 안된다
        for(Object ss:s)
        {
        	String key=(String)ss;
        	System.out.println(key+":"+map.get(key));
        }
        // Set : 순서가 없다 => 가급적이면 출력시에 List를 이용한다 (순차적이다)
        // => Map은 클래스 관리
