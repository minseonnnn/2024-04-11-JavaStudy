 ...
 *               예) 버튼을 클릭 => 클릭한다는 기능은 같지만 버튼마다 각각의 기능이 다름
 ...
 *                  -----------------------------------------------------
 *                   연결시에 따로 클래스를 만들면 소스가 모두 바뀌어야 함=> 한개로 통합 
 *                                                            --------
 ...
 *               => 클래스마다의 공통 기능을 추출 => 선언 => 필요시마다 상속 받아서 구현 
 *                  ---------------------
 *                  
 ...
 *                  }
 *                 --------------------------
 *                  추상메소드 => 구현이 안된 메소드 ==> 232page
 *                  [접근지정어] abstract 리턴형 메소드명(매개면수...);
 *                  => 데이터베이스
