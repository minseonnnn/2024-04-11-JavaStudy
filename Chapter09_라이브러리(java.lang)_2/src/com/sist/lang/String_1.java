 ...
 *                    문자열 결합     
 *             => 오버로딩 
 *             public String replace(char c1,char c2) => char c1을 c2로 변경
 *                                   ------- --------
 *                                           변경할 문자
 *                                   변경해야하는 문자(대상)
...
public class String_1 {
	...
	public static void main(String[] args) {
		...
		if(s1==s2) // ==은 객체일때 => 메모리 주소값을 비교한다 => 실제 문자열만 비교할때는 equals
		{
