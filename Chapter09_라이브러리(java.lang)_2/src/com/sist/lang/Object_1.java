 ...
 *           ----------------------
 *             상수 (변수는 존재하지 않는다)
 *             (public static final) int a=100; // 반드시 선언과 동시에 초기화값을 설정 => 변경이 불가능 
 *           ----------------------
 *             구현이 안된 메소드
...
class Box implements Cloneable
{
	...
	// throws 문장의 뒤에 붙는 예외클래스는 => RuntimeException 관련은 없다 => 예외처리를 하고 사용한다 
...
public class Object_1 {
	...
	public static void main(String[] args) {
        ...
        System.out.println(s1); // slq.toString() => toString()
