 ...
 *        ------ 예외처리 (에러를 사전에 방지 => 비정상 종료 방지하는 프로그램)
 *    => 자바
 ...
 *                                      3버전 => 4,5버전 출시
 *                                      ------------------ 
 *     => Front : 자바스트트 중심 (JavaScript => Jquery, Ajax, NodeJS, VueJS, ReactJS)
 *                            -----------                         ---------------
 *                            | TypeScript                         | NextJS  
 *                                -------------------------------
 ...
 *      InterrupedException
 *        Thread/sleep() => 충돌
 *        => 쓰레드는 프로그램안에서 여러개의 프로그램을 동시에 실현
 *      ---------------------- 쓰레드 관련  
 *      
 *    UnCheckException : 필요시에만 예외처리를 한다 => 예외처리를 생략할 수 있다
 *                       => 지금까지 사용한 클래스
 *            |           
 *        ArrayIndexOutOfBoundsException => 배열범위 초가
