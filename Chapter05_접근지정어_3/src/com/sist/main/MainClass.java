 ...
 *      }
 *     ------------------------------------------------------------------------------------------------------
 *      정적변수(static)                     컴파일시에 메모리에 저장       자신의 클래스전체    프로그램시 해제   MethodArea
 ...
 *        -------------------
 *         Stack ==> 지역변수 , 매개변수 => 메모리 자체 관리 => 매소드가 종료되면 자동으로 사라진다
 *                   -------------- 메소드안에서 사용이 가능 
 *        -------------------
 ...
 *     ------------------------------------------------------------------------------------------------------
 *      지역변수                             메소드 호출시마다 메모리 생성   메소드안에서만 사용   메소드가 종료(return)   Stack 
 *      Stack => LIFO (Last In First Out) => 주차장
 *      void display()
 *      {  ======================> a => b => c => c => b => a
 *          int a=10;
 *          {
